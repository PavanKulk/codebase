...
//#include "/root/libxml2/libxml2/include/libxml/encoding.h"
...
static int hostapd_driver_init(struct hostapd_iface *iface)
{
	...
	wpa_printf(MSG_INFO, "Pavan edit: hostapd driver initiated");
	return 0;
}
...
/*static void test_send_mgmt(void *eloop_data, void *user_ctx)
{
	...
	wpa_printf(MSG_INFO, "Pavan edit: Timeout event triggered, displaying static parameters");
	wpa_printf(MSG_INFO, "Pavan edit: bssid = %u", hapd->conf->bssid);
	wpa_printf(MSG_INFO, "Pavan edit: ifacename = %s", hapd->conf->iface);
	wpa_printf(MSG_INFO, "Pavan edit: channel = %u", hapd->iconf->channel);
}*/
...
static void get_params_handler(void *eloop_ctx, void *timeout_ctx)
{
	struct hapd_interfaces *interfaces = eloop_ctx;
